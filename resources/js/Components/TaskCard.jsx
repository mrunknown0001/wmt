...
export default function TaskCard({ task, projectId, canEdit, canDelete, onDelete }) {
    ...
    return (
        ...
        >
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2 line-clamp-2">{task.title}</p>
