...
export default function Create() {
    const { roles, departments, teams } = usePage().props;
                ...
                <Card>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Input label="Password" id="password" type="password" value={data.password} onChange={(e) => setData('password', e.target.value)} error={errors.password} />
                        ...
                        <div className="flex justify-end gap-3 pt-4">
                            ...
                            <Button type="submit" processing={processing} processingText="Creating...">Create User</Button>
                        </div>
                    </form>
                </Card>
            </div>
