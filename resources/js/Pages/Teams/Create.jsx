...
export default function Create() {
    const { departments, users } = usePage().props;
    ...
    return (
        <AuthenticatedLayout title="Create Team">
                ...
                <Card>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex justify-end gap-3 pt-4">
                            ...
                            <Button type="submit" processing={processing} processingText="Creating...">Create Team</Button>
                        </div>
                    </form>
                </Card>
            </div>
